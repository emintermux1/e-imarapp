...
async def get_layers(
    ...
    if not wms_url and not wfs_url:
        layers = []
        ...
        return {"service_type": "REGISTRY", "identification": None, "layers": layers, "url": "/api/v1/map/layers"}
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=f"OGC service error: {exc}")
