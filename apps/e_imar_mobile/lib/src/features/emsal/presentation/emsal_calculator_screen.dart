    ...
    return Scaffold(
      ...
      body: DecoratedBox(
        ...
        child:
          ...
          if (r != null) ...[
            ValueScoreCard(
                score: r.roi.clamp(0, 99).round(),
                title: 'Brüt ROI Potansiyeli',
                subtitle:
                    '%${r.roi.toStringAsFixed(1)} mock varsayım • finansman ve ruhsat dahil değil'),
            const SizedBox(height: 14),
            GridView.count(
                shrinkWrap: true,
                ...
                children: [
                  MetricCard(
                      title: 'Toplam İnşaat',
                      value: '${r.totalConstructionArea.toStringAsFixed(0)} m²',
                      icon: Icons.apartment_rounded),
                  MetricCard(
                      title: 'Daire Adedi',
                      value: '${r.apartmentCount}',
                      icon: Icons.meeting_room_rounded),
                  MetricCard(
                      title: 'Tahmini Maliyet',
                      value: _money(r.estimatedCost),
                      icon: Icons.account_balance_wallet_rounded),
                  MetricCard(
                      title: 'Satış Potansiyeli',
                      value: _money(r.salesPotential),
                ...
                child: Column(
                  ...
                  ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                          value: (r.roi / 140).clamp(0, 1).toDouble(),
                          minHeight: 16,
                          color: AppColors.emerald,
                          backgroundColor: AppColors.emerald.withOpacity(.14))),
                  const SizedBox(height: 12),
                  const InsightCard(
                      title: 'Fintech notu',
                      message:
                          'Gelir, maliyet ve satış potansiyeli mock katsayılarla hesaplanır; gerçek piyasa entegrasyonu Faz 2 kapsamındadır.',
            ...
            child:
              ...
              Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .titleSmall
                      ?.copyWith(color: Colors.white.withOpacity(.78))),
            ])),
      );
}
...
class _Input extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TextField(
      ...
      decoration: InputDecoration(
          labelText: label, suffixText: suffix, prefixIcon: Icon(icon)));
}
