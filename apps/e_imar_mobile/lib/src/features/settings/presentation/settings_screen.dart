    ...
    return Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(AppSpacing.lg), children: [
          ...
          SwitchListTile(
              ...
              subtitle:
                  const Text('OLED ekranlarda pil dostu premium koyu görünüm')),
          ListTile(
              leading: const Icon(Icons.auto_awesome_rounded),
              title: const Text('AI değerleme ve piyasa zekâsı'),
              subtitle: const Text(
                  'Danışman nitelikli m² fiyatı, emsal özeti ve etik kaynak açıklamaları'),
              trailing: const Icon(Icons.chevron_right_rounded),
              onTap: () => context.push('/ai-valuation')),
          const ListTile(
              leading: Icon(Icons.security_rounded),
              title: Text('Gizlilik ve güvenlik'),
              subtitle: Text('Güvenli varsayılan Firebase kuralları hazır')),
        ]));
  }
}
