                  ...
                  children: [
                    ...
                    _ActionTile(
                      ...
                      onTap: () async {
                        ...
                        try {
                          final bytes = await const PremiumParcelReportService()
                          ...
                          messenger.showSnackBar(
                            SnackBar(
                                content: Text(
                                    'PDF rapor hazırlandı (${bytes.lengthInBytes} bayt). Paylaşım akışı sonraki fazda eklenecek.')),
                          );
                        } catch (_) {
                          messenger.showSnackBar(const SnackBar(
                              content: Text(
                                  'PDF raporu şu anda hazırlanamadı. Lütfen daha sonra tekrar deneyin.')));
                        }
                      },
                    ),
                    _ActionTile(
