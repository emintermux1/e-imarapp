...
class _MockMapPainter extends CustomPainter {
  ...
  void _drawContours(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = AppColors.mapContour.withValues(alpha: .09)
  ...
  void _drawRoads(Canvas canvas, Size size) {
    ...
    final road = Paint()
      ..color = AppColors.mapRoad.withValues(alpha: .52)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 9
      ..strokeCap = StrokeCap.round;
    final lane = Paint()
    ...
    final secondary = Paint()
      ..color = const Color(0xFFB8D1BE).withValues(alpha: .22)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 5
      ..strokeCap = StrokeCap.round;
    for (var i = 0; i < 4; i++) {
      ...
      canvas.drawCircle(
          ...
          Paint()
            ..shader = RadialGradient(colors: [
              spot.$2.withValues(alpha: .25),
              spot.$2.withValues(alpha: 0.0)
  ...
  void _drawParcels(Canvas canvas, Size size) {
    final fill = Paint()
      ..color = AppColors.mapParcel.withValues(alpha: .075)
      ..style = PaintingStyle.fill;
    final stroke = Paint()
      ..color = AppColors.mapParcel.withValues(alpha: .38)
      ..style = PaintingStyle.stroke
      ..strokeWidth = .85;
  ...
  void _drawSelectedParcel(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
        path,
        Paint()
          ..color = AppColors.emerald.withValues(alpha: .23)
  ...
  void _drawLocation(Canvas canvas, Size size) {
    ...
    for (final r in const [18.0, 32.0, 48.0]) {
      canvas.drawCircle(
          ...
          r,
          Paint()
            ..color = AppColors.lime.withValues(alpha: .06)
            ..style = PaintingStyle.fill);
      canvas.drawCircle(
          center,
          r,
