...
class AppConfig {
  const AppConfig({required this.environment, required this.mapboxAccessToken, required this.openAiKey, required this.grokKey, required this.firebaseProjectId});
  ...
  factory AppConfig.fromEnvironment() {
    return const AppConfig(
      ...
      firebaseProjectId: String.fromEnvironment('FIREBASE_PROJECT_ID', defaultValue: 'e-imar-placeholder'),
    );
  }
