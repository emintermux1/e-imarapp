  ...
  Widget build(BuildContext context) {
    ...
    final color = switch (variant) {
      ...
      GlassVariant.subtle => (isDark ? Colors.white : AppColors.deepGreen)
          .withOpacity(isDark ? .075 : .055),
    };
    final borderColor =
        isDark ? Colors.white.withOpacity(.13) : Colors.white.withOpacity(.72);
    final content = Material(
      color: color,
      shape: RoundedRectangleBorder(
          borderRadius: radius, side: BorderSide(color: borderColor)),
      child: InkWell(
          onTap: onTap,
          borderRadius: radius,
          child: Padding(
      ...
      child: ClipRRect(
          ...
          child: BackdropFilter(
              filter: ImageFilter.blur(
                  sigmaX: variant == GlassVariant.elevated ? 22 : 16,
                  sigmaY: variant == GlassVariant.elevated ? 22 : 16),
              child: content)),
    );
  }
}
        ...
        child: Row(children: [
          ...
          Expanded(
              child: Column(
                  ...
                  children: [
                if (badge != null)
                  StatusBadge(label: badge!, tone: BadgeTone.info),
                ...
                child: Column(
                  ...
                  Text(subtitle,
                      style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          color: Colors.white.withOpacity(.78), height: 1.35))
                ])),
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
          ...
          color: enabled ? null : AppColors.slate.withOpacity(.18),
          borderRadius: BorderRadius.circular(AppRadius.pill),
...
class IconActionChip extends StatelessWidget {
  const IconActionChip(
      {required this.label, required this.icon, this.onTap, super.key});
  final String label;
  final IconData icon;
  final VoidCallback? onTap;
  @override
  Widget build(BuildContext context) => ActionChip(
      avatar: Icon(icon, size: 18, color: AppColors.emerald),
      label: Text(label),
      onPressed: onTap,
      side: BorderSide(
...
class PremiumBottomSheetShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPadding(
        ...
        child: DecoratedBox(
            decoration: BoxDecoration(
                color: isDark ? AppColors.surfaceDark : AppColors.porcelain,
                borderRadius: const BorderRadius.vertical(
                    top: Radius.circular(AppRadius.xl)),
                boxShadow: AppShadows.elevated(Colors.black)),
      ...
      child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(
                ...
                height: 60,
                decoration: BoxDecoration(
                    color: AppColors.emerald.withOpacity(.13),
