...
abstract final class AppTheme {
  ...
  static ThemeData _theme(Brightness brightness, ColorScheme scheme) {
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(elevation: 0, color: isDark ? const Color(0xFF12211B) : Colors.white, surfaceTintColor: Colors.transparent, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppRadius.lg), side: BorderSide(color: outline.withOpacity(.7)))),
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: fieldFill,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
        labelStyle: TextStyle(color: isDark ? AppColors.mint.withOpacity(.76) : AppColors.slate),
        hintStyle: TextStyle(color: AppColors.slate.withOpacity(.72)),
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.md), borderSide: BorderSide(color: outline.withOpacity(.75))),
        ...
        disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AppRadius.md), borderSide: BorderSide(color: outline.withOpacity(.36))),
      ),
      filledButtonTheme: FilledButtonThemeData(style: FilledButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppRadius.pill)), padding: const EdgeInsets.symmetric(horizontal: 22, vertical: 15), disabledBackgroundColor: AppColors.slate.withOpacity(.18))),
      ...
      chipTheme: ChipThemeData(backgroundColor: isDark ? const Color(0xFF13241E) : Colors.white, selectedColor: AppColors.emerald.withOpacity(.16), side: BorderSide(color: outline.withOpacity(.85)), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppRadius.pill)), labelStyle: textTheme.labelLarge),
      navigationBarTheme: NavigationBarThemeData(
        ...
        indicatorColor: AppColors.emerald.withOpacity(isDark ? .22 : .16),
