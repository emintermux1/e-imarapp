  ...
  static ThemeData _theme(Brightness brightness, ColorScheme scheme) {
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
          elevation: 0,
          color: isDark ? const Color(0xFF12211B) : Colors.white,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(
            color: isDark ? AppColors.mint.withOpacity(.76) : AppColors.slate),
        ...
        enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(AppRadius.md),
            borderSide: BorderSide(color: outline.withOpacity(.75))),
        ...
        disabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(AppRadius.md),
            borderSide: BorderSide(color: outline.withOpacity(.36))),
      ),
      filledButtonTheme: FilledButtonThemeData(
          style: FilledButton.styleFrom(
              ...
              disabledBackgroundColor: AppColors.slate.withOpacity(.18))),
      ...
      chipTheme: ChipThemeData(
          backgroundColor: isDark ? const Color(0xFF13241E) : Colors.white,
          selectedColor: AppColors.emerald.withOpacity(.16),
          side: BorderSide(color: outline.withOpacity(.85)),
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(AppRadius.pill)),
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(
          backgroundColor: isDark ? AppColors.glassDark : Colors.white,
          foregroundColor: isDark ? Colors.white : AppColors.deepGreen,
          elevation: 0,
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(AppRadius.pill))),
    );
