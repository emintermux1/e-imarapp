    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(
            color: isDark
                ? AppColors.mint.withValues(alpha: .76)
                : AppColors.slate),
        ...
        disabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(AppRadius.md),
            borderSide: BorderSide(color: outline.withValues(alpha: .36))),
      ),
      filledButtonTheme: FilledButtonThemeData(
          style: FilledButton.styleFrom(
              ...
              disabledBackgroundColor: AppColors.slate.withValues(alpha: .18))),
      ...
      chipTheme: ChipThemeData(
          ...
          selectedColor: AppColors.emerald.withValues(alpha: .16),
