      ...
      <PopoverAnchor asChild>
        <div className="mx-auto w-full max-w-[720px]">
          <button
            ...
            className={cn(
              "group flex h-10 w-full items-center gap-2 rounded-full px-4",
              "border border-white/60 bg-white/74 text-sm text-fg-secondary shadow-[inset_0_1px_0_rgb(255_255_255/0.88),0_14px_36px_-28px_rgb(var(--accent-navy)/0.7)]",
