...
export interface AppEnvironment {
  ...
  NEXT_PUBLIC_EIMAR_API_BASE_URL?: string;
  NEXT_PUBLIC_EIMAR_SITE_URL?: string;
}

const HTTP_URL_ENV_NAMES = ['MINIO_ENDPOINT', 'OPENSEARCH_URL', 'PG_TILESERV_URL', 'PUSH_GATEWAY_URL', 'PUBLIC_API_BASE_URL', 'NEXT_PUBLIC_API_BASE_URL', 'NEXT_PUBLIC_EIMAR_API_BASE_URL', 'NEXT_PUBLIC_EIMAR_SITE_URL'] as const;
