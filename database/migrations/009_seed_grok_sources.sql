...
values
  ...
  ('suleymanpasa-keos-imar', 'Süleymanpaşa Belediyesi KEOS İmar Durumu', 'municipal', 'municipal_gis', 'https://keos.suleymanpasa.bel.tr:8080/imardurumu/index.aspx', 'unknown', 'Seed municipal KEOS portal; live probing determines endpoint health and preserves the published :8080 port.', array['zoning_status', 'municipal_gis', 'netcad_keos'], array[]::text[]),
  ('mustafakemalpasa-keos-imar', 'Mustafakemalpaşa Belediyesi KEOS İmar Durumu', 'municipal', 'municipal_gis', 'http://keos.mustafakemalpasa.bel.tr/imardurumu/index.aspx', 'unknown', 'Seed municipal KEOS portal; live probing determines endpoint health.', array['zoning_status', 'municipal_gis', 'netcad_keos'], array[]::text[]),
  ('gelibolu-keos-imar', 'Gelibolu Belediyesi KEOS İmar Durumu', 'municipal', 'municipal_gis', 'https://keos.gelibolu.bel.tr/imardurumu/', 'unknown', 'Seed municipal KEOS portal; live probing determines endpoint health.', array['zoning_status', 'municipal_gis', 'netcad_keos'], array[]::text[]),
  ('caycuma-keos', 'Çaycuma Belediyesi KEOS', 'municipal', 'municipal_gis', 'https://keos.caycuma.bel.tr/', 'unknown', 'Seed municipal KEOS/KBS portal; live probing determines endpoint health and exact public capabilities.', array['municipal_gis', 'netcad_keos'], array[]::text[]),
  ('kecioren-kbs', 'Keçiören Belediyesi KBS', 'municipal', 'municipal_gis', 'https://kbs.kecioren.bel.tr/', 'unknown', 'Seed municipal KBS portal; live probing determines endpoint health and exact public capabilities.', array['municipal_gis', 'parcel_lookup'], array[]::text[])
